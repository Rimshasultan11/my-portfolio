  ...
  return (
    <div className="sm:p-6 md:flex md:justify-between md:items-center relative   lg:bg-transparent">
      <div className="container mx-auto flex justify-between items-center">
        <div className="text-2xl font-bold p-10 " data-aos="zoom-in" data-aos-duration="1200" data-aos-delay="100">
          Rimsha{" "}
          <span
        ...
        <div className="md:hidden z-50">
          {isOpen ? (
            <MdOutlineCancelPresentation size={30} onClick={toggleMenu} />
          ) : (
