...
const About = () => {
  return (
    <div id='about'>
      <div className=' title text-center'  data-aos="zoom-in"><span>About Me</span></div>

<p className='p-10  text-lg'>"I am a dedicated web developer and experienced teacher with skills in HTML, CSS, and TypeScript.
     ...
     <div className="p-10   text-2xl " data-aos="zoom-in-right">
            ...
            <p className="pt-4 ">Speciality:
                <span className='text-[#e93654]'>Web-Designer </span>
               </p>
               <p className="pt-4">Adress:
               ...
               <div className='w-[50%] h-40%  rounded-xl ml-[10%]  border-2 border-[#e93654] shadow-md shadow-[#e93654]'   data-aos="zoom-in-left">
                <Image src={profile3} alt='about-Profile' width={400} height={300} className='rounded-xl'/>
